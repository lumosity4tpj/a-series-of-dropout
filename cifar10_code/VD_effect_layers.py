...
@weak_module
class VariationalDropoutfce(_Linear):
    def __init__(self, in_features, out_features, bias=True, p=0.5, dropout_type='A', deterministic_test=False, deterministic_limit=True, eps=1e-8):
        super(VariationalDropoutfce,self).__init__(in_features, out_features, bias)
...
@weak_module
class VariationalDropoutcnne(_ConvNd):
    def __init__(self, in_channels, out_channels, kernel_size, stride=1,
        ...
        super(VariationalDropoutcnne, self).__init__(
