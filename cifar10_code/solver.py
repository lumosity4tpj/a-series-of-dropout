...
from models import NETNoDropout,NETBernoulliDropout,NETGaussianDropoutWang,NETGaussianDropoutSrivastava,\
                    NETVariationalDropoutA,NETVariationalDropoutB,EffectNETVariationalDropoutA,EffectNETVariationalDropoutB,\
                        NETVariationalDropoutSparse,NETVariationalDropoutHierarchical,CompressNETVariationalDropoutSparse,CompressNETVariationalDropoutHierarchical
...
class CNN(object):
    ...
    def load_model(self,net_pth):        
        ...
        elif self.dropout_type == 'NETGaussianDropoutWang':
        ...
        elif self.dropout_type == 'NETVariationalDropoutSparse':
            net = NETVariationalDropoutSparse(scale=self.scale)
        elif self.dropout_type == 'NETVariationalDropoutHierarchical':
            net = NETVariationalDropoutHierarchical(scale=self.scale)
        elif self.dropout_type == 'CompressNETVariationalDropoutSparse':
            net = CompressNETVariationalDropoutSparse(scale=self.scale)
        elif self.dropout_type == 'CompressNETVariationalDropoutHierarchical':
            net = CompressNETVariationalDropoutHierarchical(scale=self.scale)
        else:
